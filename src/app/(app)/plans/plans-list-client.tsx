...
import type { PlanListItem } from "@/lib/db/plans";
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex items-center gap-3 text-xs text-muted-foreground">
                        ...
                        <span>
                          Baseline: {plan.baselineScore ?? "—"}
                          {plan.predictedRange ? ` → ${plan.predictedRange}` : ""}
                        </span>
                        <span>{plan.totalWeeks} weeks</span>
                        <span>Created {plan.createdAt.split("T")[0]}</span>
                      </div>
                    </div>
                  </div>
